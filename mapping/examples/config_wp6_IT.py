...
final_date = datetime(2010,2,10,0)
...
sw_time_scheme = 'Euler' # Time scheme of the model (e.g. Euler,lf)
...
D_He = None#1200e3 # Space scale of gaussian decomposition for He (in m)

T_He = None#timedelta(days=20).total_seconds() # Time scale of gaussian decomposition for He (in m)
