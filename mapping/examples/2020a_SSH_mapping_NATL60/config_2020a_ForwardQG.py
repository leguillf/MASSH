...
name_experiment = '2020a_ForwardQG'
...
myGRID = dict(
    ...
    path_init_grid = 'data/dc_ref/NATL60-CJM165_GULFSTREAM_y2012m10d01.1h_SSH.nc', 
...
myDIAG = dict(
    ...
    name_bas = 'data/2020a_SSH_mapping_NATL60_DUACS_swot_en_j1_tpn_g2.nc',
