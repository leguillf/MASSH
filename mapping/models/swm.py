...
class Swm: 
    ...
    def __init__(self,X=None,Y=None,dt=None,bc_kind='1d',g=9.81,f=1e-4,Heb=0.7,**arr_kwargs):
        ...
        self.nitg = self.nh
        self.nparams = self.nHe + self.nBc + self.nitg
        ...
        self.sliceitg = slice(self.nu+self.nv+self.nh+self.nHe+self.nBc,
                             self.nu+self.nv+self.nh+self.nHe+self.nBc+self.nitg)
